...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_mdns_plugin/flutter_mdns_plugin.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/share_extend/share_extend.framework"
