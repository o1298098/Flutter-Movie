...
class MyListModel {
  ...
  MyListModel.fromParams({this.page, this.totalPages, this.totalResults, this.results});

  factory MyListModel(jsonStr) => jsonStr == null ? null : jsonStr is String ? new MyListModel.fromJson(json.decode(jsonStr)) : new MyListModel.fromJson(jsonStr);
  ...
  MyListModel.fromJson(jsonRes) {
    ...
    for (var resultsItem in results == null ? [] : jsonRes['results']){
            results.add(resultsItem == null ? null : new MyListResult.fromJson(resultsItem));
    }
  }
