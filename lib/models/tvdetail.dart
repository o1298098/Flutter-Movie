...
class TVDetailModel {
  ...
  TVDetailModel.fromJson(jsonRes) {
    ...
    for (var created_byItem in created_by == null ? [] : jsonRes['created_by']){
            created_by.add(created_byItem == null ? null : new CreatedBy.fromJson(created_byItem));
    }

    episode_run_time = jsonRes['episode_run_time'] == null ? null : [];

    for (var episode_run_timeItem in episode_run_time == null ? [] : jsonRes['episode_run_time']){
    ...
    for (var networksItem in networks == null ? [] : jsonRes['networks']){
            networks.add(networksItem == null ? null : new NetWork.fromJson(networksItem));
    }
...
class Season {
  ...
  Season.fromParams({this.episode_count, this.id, this.season_number, this.air_date, this.name, this.overview, this.poster_path});
