...
class SearchResultModel {
  ...
  SearchResultModel.fromParams({this.page, this.totalPages, this.totalResults, this.results});
...
class SearchResult {
  ...
  SearchResult.fromJson(jsonRes) {
    ...
    for (var knownForItem in knownFor == null ? [] : jsonRes['known_for']){
            knownFor.add(knownForItem == null ? null : new KnownFor.fromJson(knownForItem));
    }

    originCountry = jsonRes['origin_country'] == null ? null : [];

    for (var originCountryItem in originCountry == null ? [] : jsonRes['origin_country']){
...
class KnownFor {
  ...
  KnownFor.fromParams({this.id, this.voteCount, this.popularity, this.voteAverage, this.adult, this.video, this.backdropPath, this.mediaType, this.originalLanguage, this.originalTitle, this.overview, this.posterPath, this.releaseDate, this.title, this.genreIds});
